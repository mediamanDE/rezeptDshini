...
class RecipeController extends Controller
{
	...
	public function accessRules()
	{
		return array(
			array('allow',  // allow all users to perform 'index' and 'view' actions
				'actions'=>array('index','view', 'GetRecipe'),
				'users'=>array('*'),
			),
	...
	public function actionGetRecipe($token="", $emotional = "", $rational = "")
	{
		...
		if ($recipeCount == 0) {
			print "Kein Rezept in dieser Einstellung gefunden";
			return;
		}

		$this->giveOut($recipes[rand(0,$recipeCount-1)]);
		return;
	}

	private function giveOut($recipe)
	{
	    print $recipe->title;
